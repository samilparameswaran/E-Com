...
<html>
<head>
<title>About Our Samsung E commerce Site</title>
<!--/tags -->
...
<div class="header" id="home">
	<div class="container">
		...
		<c:if test='<%=(Boolean)session.getAttribute("loggedIn")==null%>'>
			...
			<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:info@example.com">s.parameswar@samsung.com</a></li>
		</ul>
	</div>
</div>
<!-- //header -->
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-3 logo_agile">
				<h1><a href="index"><span>S</span>amsung Mobile <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
